    ...
    template: `
        <div class="h-full flex justify-content-center align-items-center">
            <div class="w-8 md:w-5">
                <app-error-details image="forbidden" code="403" [title]="'mensagem.error.403.titulo' | translate" [description]="'mensagem.error.403.mensagem' | translate"></app-error-details>
            </div>
        </div>
    `,
